<template>
    ...
    <div class="container">
        <router-link class="navbar-brand" to="/">Installment Cars</router-link>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <router-link to="/data" class="btn btn-primary btn-block">+ Request validation</router-link>
                        </div>
                    </div>
                </div>
        ...
        <section class="validation-section mb-5">
            <div class="section-header mb-3">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <router-link to="/data" class="btn btn-primary btn-lg btn-block">+ Add Installment Cars</router-link>
                    </div>
                </div>
            </div>
